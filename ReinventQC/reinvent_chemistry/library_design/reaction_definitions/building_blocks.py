...
from ReinventQC.reinvent_chemistry.library_design.enums import ScaffoldMemoryFieldsEnum
from ReinventQC.reinvent_chemistry.library_design.reaction_definitions.blocks_for_compound_dto import BuildingBlocksForCompoundDTO
