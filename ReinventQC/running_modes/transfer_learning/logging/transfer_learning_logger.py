...
from ReinventQC.running_modes.transfer_learning.logging.local_transfer_learning_logger import LocalTransferLearningLogger
from ReinventQC.running_modes.transfer_learning.logging.remote_transfer_learning_logger import RemoteTransferLearningLogger
