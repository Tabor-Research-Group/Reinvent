...
from ReinventQC.running_modes.scoring.logging.local_scoring_logger import LocalScoringLogger
from ReinventQC.running_modes.scoring.logging.remote_scoring_logger import RemoteScoringLogger
